...
public class RelationSourceItem extends Item
{
	...
	public final Collection<RelationTargetItem> getTarget()
	{
		return RelationItem.relation.getTargets(this);
	}
	
	// TODO should be generated
	public final boolean addToTarget(final RelationTargetItem target)
	{
		return RelationItem.relation.addToTargets(this, target);
	}
	
	// TODO should be generated
	public final boolean removeFromTarget(final RelationTargetItem target)
	{
