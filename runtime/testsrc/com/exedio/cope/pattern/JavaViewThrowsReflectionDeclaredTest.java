...
public class JavaViewThrowsReflectionDeclaredTest
{
	@Test void test()
	{
		...
		final IOException actual = (IOException)ite.getCause();
	...
	private static final class MyItem extends Item
	{
		...
		String getView() throws IOException
		{
			throw new IOException("getView message");
		}
	...
	static
	{
		MODEL.enableSerialization(JavaViewThrowsReflectionDeclaredTest.class, "MODEL");
	}
}
