...
public final class EnumMapFieldFinalItem extends Item
{
	...
	final String getTextWithFallback(final EnumMapFieldItem.Language k)
	{
		return EnumMapFieldFinalItem.text.getWithFallback(this,k);
	}

	// must not be generated by instrumentor
	final java.util.Map<EnumMapFieldItem.Language,String> getTextMapWithFallback()
	{
		return EnumMapFieldFinalItem.text.getMapWithFallback(this);
	}
