...
public class BlockFieldMediaFilterTest extends CopeAssert
{
	 ...
	 **
	 * Returns a URL the content of {@link #filter} is available under, falling back to source if necessary.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 ...
	 */
	final java.lang.String getFilterURLWithFallbackToSource()
	{
		return field().of(ABlock.filter).getURLWithFallbackToSource(item());
	}/**

	 **
	 * Returns a Locator the content of {@link #filter} is available under, falling back to source if necessary.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 ...
	 */
	final com.exedio.cope.pattern.MediaPath.Locator getFilterLocatorWithFallbackToSource()
	{
		return field().of(ABlock.filter).getLocatorWithFallbackToSource(item());
	}/**
