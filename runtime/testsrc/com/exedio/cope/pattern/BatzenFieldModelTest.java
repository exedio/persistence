...
public class BatzenFieldModelTest extends CopeAssert
{
	...
	public void testIt()
	{
		assertEqualsUnmodifiable(Arrays.asList(new Feature[]{
				...
				AnItem.code,
				eins,
				eins.of(aString), eins.of(anInt), eins.of(anEnum), eins.of(anItem), eins.of(aColor), eins.of(aColor).getRGB(), eins.of(aList),
				zwei,
				zwei.of(aString), zwei.of(anInt), zwei.of(anEnum), zwei.of(anItem), zwei.of(aColor), zwei.of(aColor).getRGB(), zwei.of(aList),
		...
		assertEqualsUnmodifiable(list(aString, anInt, anEnum, anItem, aColor, aList), eins.getTemplates());

		assertEqualsUnmodifiable(list(eins.of(aString), eins.of(anInt), eins.of(anEnum), eins.of(anItem), eins.of(aColor), eins.of(aList)), eins.getComponents());
