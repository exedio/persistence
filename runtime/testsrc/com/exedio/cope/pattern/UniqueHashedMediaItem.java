...
public final class UniqueHashedMediaItem extends Item
{
	...
	UniqueHashedMediaItem(
				final com.exedio.cope.pattern.UniqueHashedMedia.Value value)
			throws
	 ...
	 */
	static final UniqueHashedMediaItem forHash(final java.lang.String hash)
	{
		return UniqueHashedMediaItem.value.forHash(UniqueHashedMediaItem.class,hash);
	}/**

	 **
	 * Finds a uniqueHashedMediaItem by it's {@link #value}.
	 ...
	 */
	static final UniqueHashedMediaItem getOrCreate(final com.exedio.cope.pattern.Media.Value value)
			throws
				java.io.IOException
	{
