...
public class DTypeItem extends Item
{
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.pattern.DynamicModel.Type getFeaturesType()
	{
	 ...
	 */
	final void setFeaturesType(final com.exedio.cope.pattern.DynamicModel.Type type)
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.Object getFeatures(final com.exedio.cope.pattern.DynamicModel.Field field)
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setFeatures(final com.exedio.cope.pattern.DynamicModel.Field field,final java.lang.Object value)
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.pattern.DynamicModel.Type getSmallType()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setSmallType(final com.exedio.cope.pattern.DynamicModel.Type type)
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.Object getSmall(final com.exedio.cope.pattern.DynamicModel.Field field)
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setSmall(final com.exedio.cope.pattern.DynamicModel.Field field,final java.lang.Object value)
	{
