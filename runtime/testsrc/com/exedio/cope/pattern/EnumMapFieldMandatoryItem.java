...
public final class EnumMapFieldMandatoryItem extends Item
{
	 ...
	 * @param mandatory the initial value for field {@link #text}.
	 ...
	 */
	EnumMapFieldMandatoryItem(
				final java.util.EnumMap<Language,String> mandatory)
			throws
				com.exedio.cope.MandatoryViolationException,
				com.exedio.cope.StringLengthViolationException
	{
		this(new com.exedio.cope.SetValue<?>[]{
			EnumMapFieldMandatoryItem.text.map(mandatory),
		});
	}/**
	 ...
	 */
	final void setText(final Language k,final String mandatory)
	{
		EnumMapFieldMandatoryItem.text.set(this,k,mandatory);
	}/**
