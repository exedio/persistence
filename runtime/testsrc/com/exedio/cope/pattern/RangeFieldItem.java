...
public class RangeFieldItem extends Item
{
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private RangeFieldItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.pattern.Range<java.lang.String> getText()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.set public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setText(final com.exedio.cope.pattern.Range<? extends java.lang.String> text)
	{
		RangeFieldItem.text.set(this,text);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.setFrom public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setTextFrom(final String text)
	{
		RangeFieldItem.text.setFrom(this,text);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.setTo public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setTextTo(final String text)
	{
		RangeFieldItem.text.setTo(this,text);
	}/**
