...
import static com.exedio.cope.pattern.FinalSettablePriceTest.AnItem.field;
...
public class FinalSettablePriceTest extends TestWithEnvironment
{
	...
	@Test public void test()
	{
		...
		final SetValue<?> setValue = field.map(valueOf(5.5));
	...
	{
		static final PriceField field = new PriceField().toFinal().optional();
	...
	AnItem(
				@javax.annotation.Nullable final com.exedio.cope.pattern.Price field)
	{
	...
	final com.exedio.cope.pattern.Price getField()
	{
