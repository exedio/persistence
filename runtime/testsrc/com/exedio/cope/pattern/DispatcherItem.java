...
public class DispatcherItem extends Item implements Dispatchable
{
	 ...
	 */
	static final void dispatchToTarget(final com.exedio.cope.pattern.Dispatcher.Interrupter interrupter)
	{
		DispatcherItem.toTarget.dispatch(DispatcherItem.class,interrupter);
	}/**
