...
public class ThumbnailMagickItem extends Item
{
	...
	static final MediaImageMagickThumbnail thumbFull = new MediaImageMagickThumbnail(file, 20, 30).density(300).flatten("white");
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private ThumbnailMagickItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	 ...
	 **
	 * Returns the content type of the media {@link #thumbFull}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getContentType public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.String getThumbFullContentType()
	{
