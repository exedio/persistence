...
public class FieldListItem extends Item
{
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private FieldListItem(final com.exedio.cope.util.ReactivationConstructorDummy d,final int pk)
	{
		super(d,pk);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	static final java.util.List<FieldListItem> getDistinctParentsOfStrings(final String element)
	{
		return FieldListItem.strings.getDistinctParents(FieldListItem.class,element);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	static final java.util.List<FieldListItem> getDistinctParentsOfDates(final Date element)
	{
		return FieldListItem.dates.getDistinctParents(FieldListItem.class,element);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	static final java.util.List<FieldListItem> getDistinctParentsOfItems(final FieldListItem element)
	{
		return FieldListItem.items.getDistinctParents(FieldListItem.class,element);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.setter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setItems(final java.util.Collection<? extends FieldListItem> items)
			throws
				com.exedio.cope.MandatoryViolationException,
				java.lang.ClassCastException
	{
