...
public class DispatcherNoneItem extends Item
{
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private DispatcherNoneItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	 ...
	 */
	static final int dispatchWrong(final com.exedio.cope.pattern.Dispatcher.Config config,final com.exedio.cope.util.Interrupter interrupter)
	{
		return DispatcherNoneItem.wrong.dispatch(DispatcherNoneItem.class,config,interrupter);
	}/**
