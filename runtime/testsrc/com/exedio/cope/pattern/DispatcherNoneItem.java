...
public class DispatcherNoneItem extends Item
{
	 ...
	 *       It can be customized with the tag <tt>@cope.dispatch public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	static final void dispatchWrong(final com.exedio.cope.pattern.Dispatcher.Config config,final com.exedio.cope.util.JobContext ctx)
	{
		DispatcherNoneItem.wrong.dispatch(DispatcherNoneItem.class,config,ctx);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.dispatch public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	static final void dispatchWrong(final com.exedio.cope.pattern.Dispatcher.Config config,final java.lang.Runnable probe,final com.exedio.cope.util.JobContext ctx)
	{
		DispatcherNoneItem.wrong.dispatch(DispatcherNoneItem.class,config,probe,ctx);
	}/**
