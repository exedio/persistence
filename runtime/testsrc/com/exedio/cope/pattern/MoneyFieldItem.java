...
public final class MoneyFieldItem extends Item
{
	...
	static final MoneyField<Currency> total = MoneyField.shared(currency).toFinal();

	static final MoneyField<Currency> price = MoneyField.exclusive(EnumField.create(Currency.class)).optional();
	 ...
	 * @param total the initial value for field {@link #total}.
	 * @throws com.exedio.cope.MandatoryViolationException if currency, total is null.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tags <tt>@cope.constructor public|package|protected|private|none</tt> in the class comment and <tt>@cope.initial</tt> in the comment of fields.
	 */
	MoneyFieldItem(
				final Currency currency,
				final com.exedio.cope.pattern.Money<Currency> total)
			throws
				com.exedio.cope.MandatoryViolationException
	{
		this(new com.exedio.cope.SetValue<?>[]{
			MoneyFieldItem.currency.map(currency),
			MoneyFieldItem.total.map(total),
		});
	}/**
	 ...
	 **
	 * Returns the value of {@link #total}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.pattern.Money<Currency> getTotal()
	{
		return MoneyFieldItem.total.get(this);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.pattern.Money<Currency> getPrice()
	{
		return MoneyFieldItem.price.get(this);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.set public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setPrice(final com.exedio.cope.pattern.Money<Currency> price)
	{
		MoneyFieldItem.price.set(this,price);
	}/**
