...
public final class MoneyFieldItem extends Item
{
	...
	// TODO should be generated by the instrumentor
	final Money<Currency> getFixedEnum()
	{
		return MoneyFieldItem.fixedEnum.get(this);
	}

	// TODO should be generated by the instrumentor
	final void setFixedEnum(final Money<Currency> fixed)
	{
		MoneyFieldItem.fixedEnum.set(this,fixed);
	}
	 ...
	 */
	@javax.annotation.Generated("com.exedio.cope.instrument")
	final void setFixed(final com.exedio.cope.pattern.Money<CurrencyFixed> fixed)
	{
