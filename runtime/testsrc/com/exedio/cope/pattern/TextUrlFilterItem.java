...
public class TextUrlFilterItem extends Item
{
	...
	void addFertigPaste(final String key)
	{
		addFertigPaste(key, Media.toValue(new byte[]{1, 2, 3}, "image/png"));
	}
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private TextUrlFilterItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	 ...
	 **
	 * Returns the content type of the media {@link #fertig}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getContentType public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.String getFertigContentType()
	{
	 ...
	 */
	final void addFertigPaste(final java.lang.String key,final com.exedio.cope.pattern.Media.Value value)
	{
		TextUrlFilterItem.fertig.addPaste(this,key,value);
	}/**
