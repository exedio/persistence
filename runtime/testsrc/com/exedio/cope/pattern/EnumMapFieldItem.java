...
public final class EnumMapFieldItem extends Item
{
	...
	static final EnumMapField<Territory, String> territory = EnumMapField.create(Territory.class, new StringField().optional());
	 ...
	 **
	 * Returns the value mapped to <tt>k</tt> by the field map {@link #territory}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	@javax.annotation.Generated("com.exedio.cope.instrument")
	final String getTerritory(final Territory k)
	{
		return EnumMapFieldItem.territory.get(this,k);
	}/**

	 **
	 * Associates <tt>k</tt> to a new value in the field map {@link #territory}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.set public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	@javax.annotation.Generated("com.exedio.cope.instrument")
	final void setTerritory(final Territory k,final String territory)
	{
		EnumMapFieldItem.territory.set(this,k,territory);
	}/**
