...
public final class HashedMediaItem extends Item
{
	 ...
	 */
	HashedMediaItem(
				final com.exedio.cope.pattern.HashedMedia.Value uniqueFinalHashedMedia)
			throws
	 ...
	 *       It can be customized with the tag <tt>@cope.set public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setOptionalHashedMedia(final com.exedio.cope.pattern.HashedMedia.Value optionalHashedMedia)
			throws
				java.io.IOException
	{
		HashedMediaItem.optionalHashedMedia.set(this,optionalHashedMedia);
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getOrCreateFor public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	static final HashedMediaItem getOrCreateForUniqueFinalHashedMedia(final com.exedio.cope.pattern.Media.Value uniqueFinalHashedMedia)
			throws
				java.io.IOException
	{
