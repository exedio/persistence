...
{
	public static final Serializer<Integer> integer = new Serializer<Integer>(Integer.class, OPTIONAL);
	
	public static final Serializer<Map> map = new Serializer<Map>(Map.class, OPTIONAL);
