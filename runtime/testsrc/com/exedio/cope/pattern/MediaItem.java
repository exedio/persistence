...
public class MediaItem extends Item
{
	...
	{
		return MediaItem.tokened.getNamedURL(this, name);
	}
	...
	{
		return MediaItem.tokened.getURL(this);
	}/**
	...
	{
		return MediaItem.tokened.getLocator(this);
	}/**
	...
	{
		return MediaItem.tokened.getContentType(this);
	}/**
	...
	{
		return MediaItem.tokened.isNull(this);
	}/**
	...
	{
		return MediaItem.tokened.getLastModified(this);
	}/**
	...
	{
		return MediaItem.tokened.getLength(this);
	}/**
	...
	{
		return MediaItem.tokened.getBody(this);
	}/**
	...
	final void getTokenedBody(final java.io.OutputStream body)
			throws
				java.io.IOException
	{
		MediaItem.tokened.getBody(this,body);
	}/**
	...
	final void setTokened(final com.exedio.cope.pattern.Media.Value tokened)
			throws
				java.io.IOException
	{
		MediaItem.tokened.set(this,tokened);
	}/**
	...
	{
		MediaItem.tokened.set(this,body,contentType);
	}/**
