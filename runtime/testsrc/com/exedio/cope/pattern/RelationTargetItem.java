...
public class RelationTargetItem extends Item
{
	...
	public final Collection<RelationSourceItem> getSource()
	{
		return RelationItem.relation.getSources(this);
	}
	
	// TODO should be generated
	public final boolean addToSource(final RelationSourceItem source)
	{
		return RelationItem.relation.addToSources(this, source);
	}
	
	// TODO should be generated
	public final boolean removeFromSource(final RelationSourceItem source)
	{
		return RelationItem.relation.removeFromSources(this, source);
	}
	
	// TODO should be generated
	public final Collection<RelationSourceItem> getVectorSource()
	{
	...
	public static final com.exedio.cope.Type TYPE =
		new com.exedio.cope.Type(RelationTargetItem.class)
;}
