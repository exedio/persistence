...
public class ScheduleTest extends AbstractRuntimeModelTest
{
	...
	public void testDaily()
	{
		...
		run(2, "2008/03/17-00:00");
		assertLogs(
				log("2008/03/15-00:00", "2008/03/16-00:00", "1/2"),
				log("2008/03/16-00:00", "2008/03/17-00:00", "2/2"));
		assertRuns(
				ern(DAILY, "2008/03/15-00:00", "2008/03/16-00:00", "2008/03/17-00:00"),
				ern(DAILY, "2008/03/16-00:00", "2008/03/17-00:00", "2008/03/17-00:00"));

		run(3, "2008/03/20-00:00");
		assertLogs(
		...
		assertRuns(
				ern(DAILY, "2008/03/17-00:00", "2008/03/18-00:00", "2008/03/20-00:00"),
				ern(DAILY, "2008/03/18-00:00", "2008/03/19-00:00", "2008/03/20-00:00"),
				ern(DAILY, "2008/03/19-00:00", "2008/03/20-00:00", "2008/03/20-00:00"));
	}

	public void testFail()
	{
		run(1, "2008/03/17-00:00");
		assertLogs(
		...
		item.setFail(false);
		run(1, "2008/03/18-00:00");
		assertLogs(
				log("2008/03/17-00:00", "2008/03/18-00:00"));
		assertRuns(
				ern(DAILY, "2008/03/17-00:00", "2008/03/18-00:00", "2008/03/18-00:00"));
	}

	public void testStop2()
	{
		run(1, "2008/03/11-00:00", 2);
		assertLogs(
				log("2008/03/10-00:00", "2008/03/11-00:00"));
		assertRuns(
				ern(DAILY, "2008/03/10-00:00", "2008/03/11-00:00", "2008/03/11-00:00"));
	}
	...
	public void testWeekly()
	{
		...
		assertRuns(
				ern(WEEKLY, "2008/03/10-00:00", "2008/03/17-00:00", "2008/03/17-00:00"));

		run(2, "2008/03/31-00:00");
		assertLogs(
				log("2008/03/17-00:00", "2008/03/24-00:00", "1/2"),
				log("2008/03/24-00:00", "2008/03/31-00:00", "2/2"));
		assertRuns(
				ern(WEEKLY, "2008/03/17-00:00", "2008/03/24-00:00", "2008/03/31-00:00"),
				ern(WEEKLY, "2008/03/24-00:00", "2008/03/31-00:00", "2008/03/31-00:00"));

		run(3, "2008/04/21-00:00");
		assertLogs(
		...
		assertRuns(
				ern(WEEKLY, "2008/03/31-00:00", "2008/04/07-00:00", "2008/04/21-00:00"),
				ern(WEEKLY, "2008/04/07-00:00", "2008/04/14-00:00", "2008/04/21-00:00"),
				ern(WEEKLY, "2008/04/14-00:00", "2008/04/21-00:00", "2008/04/21-00:00"));
	}
	...
	public void testMonthly()
	{
		...
		run(1, "2008/04/01-00:00");
		assertLogs(
				log("2008/03/01-00:00", "2008/04/01-00:00"));
		assertRuns(
				ern(MONTHLY, "2008/03/01-00:00", "2008/04/01-00:00", "2008/04/01-00:00"));

		run(2, "2008/06/01-00:00");
		assertLogs(
				log("2008/04/01-00:00", "2008/05/01-00:00", "1/2"),
				log("2008/05/01-00:00", "2008/06/01-00:00", "2/2"));
		assertRuns(
				ern(MONTHLY, "2008/04/01-00:00", "2008/05/01-00:00", "2008/06/01-00:00"),
				ern(MONTHLY, "2008/05/01-00:00", "2008/06/01-00:00", "2008/06/01-00:00"));

		run(3, "2008/09/01-00:00");
		assertLogs(
		...
		assertRuns(
				ern(MONTHLY, "2008/06/01-00:00", "2008/07/01-00:00", "2008/09/01-00:00"),
				ern(MONTHLY, "2008/07/01-00:00", "2008/08/01-00:00", "2008/09/01-00:00"),
				ern(MONTHLY, "2008/08/01-00:00", "2008/09/01-00:00", "2008/09/01-00:00"));
	}
	...
	public void testDaylightSavingDailyShorter()
	{
		...
		run(1, "2014/03/30-00:00");
		assertLogs(
				log("2014/03/29-00:00", "2014/03/30-00:00"));
		assertRuns(
				ern(DAILY, "2014/03/29-00:00", "2014/03/30-00:00", "2014/03/30-00:00"));

		run(0, "2014/03/30-23:59:59.999");
		assertLogs();
		assertRuns();

		run(1, "2014/03/31-00:00");
		assertLogs(
				log("2014/03/30-00:00", "2014/03/31-00:00"));
		assertRuns(
				ern(DAILY, "2014/03/30-00:00", "2014/03/31-00:00", "2014/03/31-00:00"));

		run(0, "2014/03/31-23:59:59.999");
		assertLogs();
		assertRuns();

		run(1, "2014/04/01-00:00");
		assertLogs(
				log("2014/03/31-00:00", "2014/04/01-00:00"));
		assertRuns(
				ern(DAILY, "2014/03/31-00:00", "2014/04/01-00:00", "2014/04/01-00:00"));
	...
	public void testDaylightSavingDailyLonger()
	{
		...
		run(1, "2014/10/26-00:00");
		assertLogs(
				log("2014/10/25-00:00", "2014/10/26-00:00"));
		assertRuns(
				ern(DAILY, "2014/10/25-00:00", "2014/10/26-00:00", "2014/10/26-00:00"));

		run(0, "2014/10/26-23:59:59.999");
		assertLogs();
		assertRuns();

		run(1, "2014/10/27-00:00");
		assertLogs(
				log("2014/10/26-00:00", "2014/10/27-00:00"));
		assertRuns(
				ern(DAILY, "2014/10/26-00:00", "2014/10/27-00:00", "2014/10/27-00:00"));

		run(0, "2014/10/27-23:59:59.999");
		assertLogs();
		assertRuns();

		run(1, "2014/10/28-00:00");
		assertLogs(
				log("2014/10/27-00:00", "2014/10/28-00:00"));
		assertRuns(
				ern(DAILY, "2014/10/27-00:00", "2014/10/28-00:00", "2014/10/28-00:00"));
	...
	public void testReconfigure()
	{
		...
		run(1, "2008/01/21-00:00"); // Monday
		assertLogs(
				log("2008/01/17-00:00", "2008/01/21-00:00"));
		assertRuns(
				ern(WEEKLY, "2008/01/17-00:00", "2008/01/21-00:00", "2008/01/21-00:00"));
	}
	...
	public void testReconfigureWithExtraLag()
	{
		...
		run(2, "2008/01/28-00:00"); // Monday a week later
		assertLogs(
				log("2008/01/17-00:00", "2008/01/21-00:00", "1/2"),
				log("2008/01/21-00:00", "2008/01/28-00:00", "2/2"));
		assertRuns(
				ern(WEEKLY, "2008/01/17-00:00", "2008/01/21-00:00", "2008/01/28-00:00"),
				ern(WEEKLY, "2008/01/21-00:00", "2008/01/28-00:00", "2008/01/28-00:00"));
	}
