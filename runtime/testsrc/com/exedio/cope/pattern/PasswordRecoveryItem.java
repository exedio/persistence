...
public class PasswordRecoveryItem extends Item
{
	 ...
	 **
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getToken public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final long getPasswordRecoveryToken()
	{
		return PasswordRecoveryItem.passwordRecovery.getToken(this);
	}/**

	 **
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getDate public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.util.Date getPasswordRecoveryDate()
	{
		return PasswordRecoveryItem.passwordRecovery.getDate(this);
	}/**

	 **
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.createToken public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final long createPasswordRecoveryToken()
	{
		return PasswordRecoveryItem.passwordRecovery.createToken(this);
	}/**

	 **
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.try public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.String tryPasswordRecovery(final long token)
	{
		return PasswordRecoveryItem.passwordRecovery.tryToken(this,token);
	}/**
