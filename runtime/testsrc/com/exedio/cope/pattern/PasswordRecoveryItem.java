...
public class PasswordRecoveryItem extends Item
{
	 ...
	 */
	final long issuePasswordRecovery()
	{
		return PasswordRecoveryItem.passwordRecovery.issue(this);
	}/**
	 ...
	 */
	final java.lang.String redeemPasswordRecovery(final long token)
	{
		return PasswordRecoveryItem.passwordRecovery.redeem(this,token);
	}/**
