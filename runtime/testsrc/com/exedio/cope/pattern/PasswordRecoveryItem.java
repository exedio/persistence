...
public class PasswordRecoveryItem extends Item
{
	 ...
	 **
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getExpires public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.util.Date getPasswordRecoveryExpires()
	{
		return PasswordRecoveryItem.passwordRecovery.getExpires(this);
	}/**
	 ...
	 */
	final long issuePasswordRecovery(final int expiryMillis)
	{
