...
/**
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private HashItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getDummy public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.String getExplicitExternalDummy()
	{
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.setDummy public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setExplicitExternalDummy(final java.lang.String explicitExternal)
			throws
				com.exedio.cope.StringLengthViolationException
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.getDummy public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.String getImplicitExternalDummy()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setDummy public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setImplicitExternalDummy(final java.lang.String implicitExternal)
			throws
				com.exedio.cope.StringLengthViolationException
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.getDummy public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.String getInternalDummy()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setDummy public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setInternalDummy(final java.lang.String internal)
			throws
				com.exedio.cope.StringLengthViolationException
	{
