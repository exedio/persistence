...
/**
	 ...
	 **
	 * Wastes (almost) as much cpu cycles, as a call to {@link #checkExplicitExternal(String)} would have needed.
	 ...
	 **
	 * Wastes (almost) as much cpu cycles, as a call to {@link #checkImplicitExternal(String)} would have needed.
	 * Needed to prevent Timing Attacks.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.blind public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	 ...
	 **
	 * Wastes (almost) as much cpu cycles, as a call to {@link #checkInternal(String)} would have needed.
	 * Needed to prevent Timing Attacks.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.blind public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
