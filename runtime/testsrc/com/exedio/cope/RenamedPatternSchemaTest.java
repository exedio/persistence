...
public class RenamedPatternSchemaTest extends TestWithEnvironment
{
	...
	@Test void testSchemaNames()
	{
		...
		assertPrimaryKeySequenceName("CoatI_coatF_tail_this_Seq", "CoatI_coatF_tail_this_Sq6", VeilI.veilF.srcTtail());
		assertPrimaryKeySequenceName("CoatI_default_this_Seq",VeilI.emptF.srcT());
		assertPrimaryKeySequenceName("CoatI_tail_this_Seq",       "CoatI_tail_this_Sq6", VeilI.emptF.srcTtail());
		assertPrimaryKeySequenceName("CoatI_bareF_this_Seq", VeilI.bareF.srcT());
		assertPrimaryKeySequenceName("CoatI_bareF_tail_this_Seq", "CoatI_bareF_tail_this_Sq6", VeilI.bareF.srcTtail());
		assertPrimaryKeySequenceName("BareI_coatF_this_Seq", BareI.veilF.srcT());
		assertPrimaryKeySequenceName("BareI_coatF_tail_this_Seq", "BareI_coatF_tail_this_Sq6", BareI.veilF.srcTtail());
		assertPrimaryKeySequenceName("BareI_default_this_Seq",BareI.emptF.srcT());
		assertPrimaryKeySequenceName("BareI_tail_this_Seq",       "BareI_tail_this_Sq6", BareI.emptF.srcTtail());
		assertPrimaryKeySequenceName("BareI_bareF_this_Seq", BareI.bareF.srcT());
		assertPrimaryKeySequenceName("BareI_bareF_tail_this_Seq", "BareI_bareF_tail_this_Sq6", BareI.bareF.srcTtail());
