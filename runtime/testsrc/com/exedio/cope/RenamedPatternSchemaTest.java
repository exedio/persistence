...
public class RenamedPatternSchemaTest extends TestWithEnvironment
{
	...
	@Test void testSchemaNames()
	{
		...
		assertPrimaryKeySequenceName("CoatI_coatF_tail_this_Seq", VeilI.veilF.srcTtail());
		assertPrimaryKeySequenceName("CoatI_default_this_Seq",VeilI.emptF.srcT());
		assertPrimaryKeySequenceName("CoatI_tail_this_Seq",       VeilI.emptF.srcTtail());
		assertPrimaryKeySequenceName("CoatI_bareF_this_Seq", VeilI.bareF.srcT());
		assertPrimaryKeySequenceName("CoatI_bareF_tail_this_Seq", VeilI.bareF.srcTtail());
		assertPrimaryKeySequenceName("BareI_coatF_this_Seq", BareI.veilF.srcT());
		assertPrimaryKeySequenceName("BareI_coatF_tail_this_Seq", BareI.veilF.srcTtail());
		assertPrimaryKeySequenceName("BareI_default_this_Seq",BareI.emptF.srcT());
		assertPrimaryKeySequenceName("BareI_tail_this_Seq",       BareI.emptF.srcTtail());
		assertPrimaryKeySequenceName("BareI_bareF_this_Seq", BareI.bareF.srcT());
		assertPrimaryKeySequenceName("BareI_bareF_tail_this_Seq", BareI.bareF.srcTtail());
