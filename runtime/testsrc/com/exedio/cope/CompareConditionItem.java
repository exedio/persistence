...
{
	/** @cope.initial */ public static final StringField string = new StringField(OPTIONAL);
	public static final StringField otherString = new StringField(OPTIONAL);
	/** @cope.initial */ public static final IntegerField intx = new IntegerField(OPTIONAL);
	/** @cope.initial */ public static final LongField longx = new LongField(OPTIONAL);
	/** @cope.initial */ public static final DoubleField doublex = new DoubleField(OPTIONAL);
	/** @cope.initial */ public static final DateField date = new DateField(OPTIONAL);
	/** @cope.initial */ public static final DayField day = new DayField(OPTIONAL);
	/** @cope.initial */ public static final EnumField<YEnum> enumx = newEnumField(OPTIONAL, YEnum.class);
	...
	public static final ItemField<CompareConditionItem> item = newItemField(OPTIONAL, CompareConditionItem.class, NULLIFY);
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final|boolean-as-is</tt> in the comment of the field.
	 */
	public final java.lang.Integer getIntx()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	public final void setIntx(final java.lang.Integer intx)
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final|boolean-as-is</tt> in the comment of the field.
	 */
	public final java.lang.Long getLongx()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	public final void setLongx(final java.lang.Long longx)
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final|boolean-as-is</tt> in the comment of the field.
	 */
	public final java.lang.Double getDoublex()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	public final void setDoublex(final java.lang.Double doublex)
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.getter public|package|protected|private|none|non-final|boolean-as-is</tt> in the comment of the field.
	 */
	public final CompareConditionItem getItem()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.setter public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	public final void setItem(final CompareConditionItem item)
	{
