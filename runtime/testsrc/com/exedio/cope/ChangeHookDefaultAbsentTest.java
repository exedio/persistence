...
public class ChangeHookDefaultAbsentTest extends ChangeHookAbstractTest
{
	@Test void testIt()
	{
		assertEquals(
		...
		assertEvents(
				...
				"Hook#afterNew(" + i + ")");
		assertEquals("onCreate / Hook#beforeNew", i.getField());

		i.setField("onSet");
		assertEvents(
				"Hook#beforeSet(" + i + ",onSet)");
		assertEquals("onSet / Hook#beforeSet", i.getField());
	...
	public ChangeHookDefaultAbsentTest()
	{
		super(MODEL);
	}
}
