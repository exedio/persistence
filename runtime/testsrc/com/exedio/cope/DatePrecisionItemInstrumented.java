...
public final class DatePrecisionItemInstrumented extends Item
{
	 ...
	 * @throws com.exedio.cope.DatePrecisionViolationException if seconds, minutes, hours, finalSeconds, finalMinutes, finalHours violates its precision constraint.
