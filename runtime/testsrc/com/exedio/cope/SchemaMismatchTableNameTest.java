...
public class SchemaMismatchTableNameTest extends SchemaMismatchTest
{
	...
	@Test public void testIt()
	{
		...
		assertIt("not used", WARNING, WARNING, tableA.getColumn(name(ItemA.TYPE.getThis())));
		assertIt("not used", WARNING, WARNING, tableA.getColumn(name(ItemA.field)));
