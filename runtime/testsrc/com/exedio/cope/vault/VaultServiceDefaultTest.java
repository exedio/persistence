...
public class VaultServiceDefaultTest
{
	@Test void probeGenuineServiceKey()
	{
		...
		assertFails(
				...
				VaultProperties.GenuineServiceKeyProbeNotSupported.class,
	...
	@Test void newProbeAborter()
	{
		...
		assertEquals("com.exedio.cope.vault.VaultProperties$GenuineServiceKeyProbeNotSupported", aborter.getClass().getName());
	}
}
