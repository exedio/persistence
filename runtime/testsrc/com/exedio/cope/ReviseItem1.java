...
class ReviseItem1 extends Item
{
	 ...
	 * @throws com.exedio.cope.StringField.LengthViolationException if field5 violates its length constraint.
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private ReviseItem1(final com.exedio.cope.util.ReactivationConstructorDummy d,final int pk)
	{
		super(d,pk);
	}/**
	 ...
	 */
	static final com.exedio.cope.Type<ReviseItem1> TYPE = newType(ReviseItem1.class)
;}
