...
public class CopyConstraintSupplierNullFromTest
{
	@Test void testIt()
	{
		assertFails(
				...
				"insufficient template for CopyConstraint Source.field.copyFrom(target,null) (Source.fieldCopyFromtarget): " +
	...
	{
		@WrapperIgnore
		static final ItemField<Source> target = ItemField.create(Source.class).toFinal();
		@WrapperIgnore
		@UsageEntryPoint // OK: test bad API usage
		static final StringField field = new StringField().toFinal().copyFrom(target, () -> null);
