...
public class MinusIntegerItem extends Item
{
	...
	public static final MinusView<Integer> divideAB = numA.minus(numB);

	public static final MinusView<Integer> divideAC = numA.minus(numC);

	public static final MinusView<Integer> divideBC = numB.minus(numC);
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private MinusIntegerItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	...
	{
		return MinusIntegerItem.divideAB.get(this);
	}/**
	...
	{
		return MinusIntegerItem.divideAC.get(this);
	}/**
	...
	{
		return MinusIntegerItem.divideBC.get(this);
	}/**
