...
public class MinusLongItem extends Item
{
	...
	public static final MinusView<Long> divideAB = numA.minus(numB);

	public static final MinusView<Long> divideAC = numA.minus(numC);

	public static final MinusView<Long> divideBC = numB.minus(numC);
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private MinusLongItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	...
	{
		return MinusLongItem.divideAB.get(this);
	}/**
	...
	{
		return MinusLongItem.divideAC.get(this);
	}/**
	...
	{
		return MinusLongItem.divideBC.get(this);
	}/**
