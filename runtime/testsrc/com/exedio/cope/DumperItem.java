...
public class DumperItem extends Item
{
	 ...
	 * @throws com.exedio.cope.MandatoryViolationException if string, unique is null.
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	protected DumperItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	 ...
	 */
	@Deprecated
	static final DumperItem findByUnique(final java.lang.String unique)
	{
		return DumperItem.unique.searchUnique(DumperItem.class,unique);
	}/**
