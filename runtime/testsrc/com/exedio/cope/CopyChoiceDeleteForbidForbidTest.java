...
public class CopyChoiceDeleteForbidForbidTest extends TestWithEnvironment
{
	@WrapInterim private static final DeletePolicy POLICY1 = DeletePolicy.FORBID;
	@WrapInterim private static final DeletePolicy POLICY2 = DeletePolicy.FORBID;

	public CopyChoiceDeleteForbidForbidTest() { super(MODEL); }
	...
	@Test void testDeleteContainer()
	{
		assertFails(
				...
				"integrity violation on deletion of " + c + " " +
				"because of " + Part.parent + " referring to 2 item(s)");
	...
	@Test void testDeletePartChosen()
	{
		assertFails(
				p1::deleteCopeItem,
				IntegrityViolationException.class,
				"integrity violation on deletion of " + p1 + " " +
				"because of " + Container.choice + " referring to 1 item(s)");
