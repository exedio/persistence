...
class SchemaItem extends Item
{
	...
	static final StringField string = new StringField(StringField.EMPTY);
	...
	static final StringField stringMax4 = new StringField(StringField.EMPTY).optional().lengthMax(4);
	 ...
	 * @throws com.exedio.cope.MandatoryViolationException if string, anEnum, item is null.
	 ...
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.SchemaTargetItem getItemOpt()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.set public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setItemOpt(final com.exedio.cope.SchemaTargetItem itemOpt)
	{
