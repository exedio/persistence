...
/**
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private NameCollisionlongbItem(final com.exedio.cope.util.ReactivationConstructorDummy d,final int pk)
	{
		super(d,pk);
	}/**
	 ...
	 */
	@Deprecated
	static final NameCollisionlongbItem findByCode(final java.lang.String code)
	{
		return NameCollisionlongbItem.code.searchUnique(NameCollisionlongbItem.class,code);
	}/**
	 ...
	 */
	static final com.exedio.cope.Type<NameCollisionlongbItem> TYPE = newType(NameCollisionlongbItem.class)
;}
