...
public class CopyChoiceDeleteCascadeForbidTest extends TestWithEnvironment
{
	...
	public CopyChoiceDeleteCascadeForbidTest() { super(MODEL); }
	...
	@Test void testDeletePartChosenOnly()
	{
		...
		assertFails(
				...
				IntegrityViolationException.class,
				"integrity violation on deletion of " + c + " " +
				"because of Part.parent referring to 1 item(s)");
