...
public class DefaultToItem extends Item
{
	...
	*/
	 ...
	 * @param dateNow the initial value for attribute {@link #dateNow}.
	 * @throws com.exedio.cope.MandatoryViolationException if dateNow is null.
	...
	public DefaultToItem(
				...
				final java.util.Date dateNow)
			throws
				com.exedio.cope.MandatoryViolationException
	{
		this(new com.exedio.cope.SetValue[]{
			DefaultToItem.booleanNone.map(booleanNone),
			DefaultToItem.dateNow.map(dateNow),
		});
	}/**
