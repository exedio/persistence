...
public class DefaultToItem extends Item
{
	...
	*/
	 ...
	 * @param integerFive the initial value for attribute {@link #integerFive}.
	 * @param dateEight the initial value for attribute {@link #dateEight}.
	 * @throws com.exedio.cope.MandatoryViolationException if dateEight is null.
	...
	public DefaultToItem(
				...
				final int integerFive,
				final java.util.Date dateEight)
			throws
				com.exedio.cope.MandatoryViolationException
	{
		this(new com.exedio.cope.SetValue[]{
			DefaultToItem.booleanNone.map(booleanNone),
			DefaultToItem.integerFive.map(integerFive),
			DefaultToItem.dateEight.map(dateEight),
		});
	}/**
	 ...
	 */
	DefaultToItem(final com.exedio.cope.SetValue[] initialAttributes)
	{
