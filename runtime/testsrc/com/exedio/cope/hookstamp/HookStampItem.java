...
class HookStampItem extends HookStampItemSuper
{
	...
	protected HookStampItem(final com.exedio.cope.SetValue<?>... setValues)
	{
		super(setValues);
	}
	...
	static final com.exedio.cope.Type<HookStampItem> TYPE = com.exedio.cope.TypesBound.newType(HookStampItem.class);
