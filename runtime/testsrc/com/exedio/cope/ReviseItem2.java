...
class ReviseItem2 extends Item
{
	 ...
	 * @throws com.exedio.cope.StringField.LengthViolationException if field5, field6, field6b, field7 violates its length constraint.
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private ReviseItem2(final com.exedio.cope.util.ReactivationConstructorDummy d,final int pk)
	{
		super(d,pk);
	}/**
	 ...
	 */
	static final com.exedio.cope.Type<ReviseItem2> TYPE = newType(ReviseItem2.class)
;}
