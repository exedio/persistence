...
public class FeatureFieldItem extends Item
{
	...
	static final FeatureField feature = new FeatureField();
	static final FeatureField featureFinal = new FeatureField().toFinal();
	static final FeatureField featureOptional = new FeatureField().optional();
	@CopeSchemaName("featureNewname")
	static final FeatureField featureRenamed = new FeatureField().optional();
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private FeatureFieldItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	 ...
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.Feature getFeature()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.set public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setFeature(final com.exedio.cope.Feature feature)
			throws
				com.exedio.cope.MandatoryViolationException,
				com.exedio.cope.StringLengthViolationException
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.Feature getFeatureFinal()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.Feature getFeatureOptional()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.set public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setFeatureOptional(final com.exedio.cope.Feature featureOptional)
			throws
				com.exedio.cope.StringLengthViolationException
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.Feature getFeatureRenamed()
	{
	 ...
	 *       It can be customized with the tag <tt>@cope.set public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final void setFeatureRenamed(final com.exedio.cope.Feature featureRenamed)
			throws
				com.exedio.cope.StringLengthViolationException
	{
