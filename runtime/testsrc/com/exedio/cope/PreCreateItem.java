 ...
 */
class PreCreateItem extends Item
{
	...
	PreCreateItem(final SetValue... setValues)
	{
	 ...
	 **
	 * Creates a new PreCreateItem with all the fields initially needed.
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private PreCreateItem(final com.exedio.cope.util.ReactivationConstructorDummy d,final int pk)
	{
		super(d,pk);
	}/**
	...
	{
		return PreCreateItem.text.get(this);
	}/**
	...
	final void setText(final java.lang.String text)
			throws
				...
				com.exedio.cope.StringLengthViolationException
	{
		PreCreateItem.text.set(this,text);
	}/**
	 ...
	 **
	 * The persistent type information for preCreateItem.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.type public|package|protected|private|none</tt> in the class comment.
	 */
	static final com.exedio.cope.Type<PreCreateItem> TYPE = newType(PreCreateItem.class)
;}
