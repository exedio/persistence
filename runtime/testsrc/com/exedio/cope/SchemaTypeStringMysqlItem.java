...
public final class SchemaTypeStringMysqlItem extends Item
{
	...
	@MysqlExtendedVarchar static final StringField varcharExtMax = new StringField().lengthMax(85);
	@MysqlExtendedVarchar static final StringField textExtMin    = new StringField().lengthMax(86);
	@MysqlExtendedVarchar static final StringField textExtMax    = new StringField().lengthMax(20845);
	@MysqlExtendedVarchar static final StringField mediumExtMin  = new StringField().lengthMax(21846);
