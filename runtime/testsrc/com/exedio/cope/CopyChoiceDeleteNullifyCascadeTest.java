...
public class CopyChoiceDeleteNullifyCascadeTest extends TestWithEnvironment
{
	...
	public CopyChoiceDeleteNullifyCascadeTest() { super(MODEL); }
	...
	@Test void testDeleteContainer()
	{
		...
		changeHooks.assertDeleted(c, p1, p2);
	}
