...
final class DayFieldDefaultToNowItem extends Item
{
				...
				final boolean booleanNone)
	{
		this(new com.exedio.cope.SetValue<?>[]{
			DayFieldDefaultToNowItem.booleanNone.map(booleanNone),
		});
	}
	...
	{
		return DayFieldDefaultToNowItem.booleanTrue.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.booleanTrue.set(this,booleanTrue);
	}
	...
	{
		return DayFieldDefaultToNowItem.booleanNone.getMandatory(this);
	}
	...
	{
		DayFieldDefaultToNowItem.booleanNone.set(this,booleanNone);
	}
	...
	int getIntegerFive()
	{
		return DayFieldDefaultToNowItem.integerFive.getMandatory(this);
	}
	...
	{
		DayFieldDefaultToNowItem.integerFive.set(this,integerFive);
	}
	...
	{
		return DayFieldDefaultToNowItem.integerFifty.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.integerFifty.set(this,integerFifty);
	}
	...
	{
		return DayFieldDefaultToNowItem.integerNext.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.integerNext.set(this,integerNext);
	}
	...
	{
		return DayFieldDefaultToNowItem.integerNone.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.integerNone.set(this,integerNone);
	}
	...
	{
		return DayFieldDefaultToNowItem.dateEight.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.dateEight.set(this,dateEight);
	}
	...
	void touchDateEight()
	{
		DayFieldDefaultToNowItem.dateEight.touch(this);
	}
	...
	{
		return DayFieldDefaultToNowItem.dateEighty.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.dateEighty.set(this,dateEighty);
	}
	...
	{
		DayFieldDefaultToNowItem.dateEighty.touch(this);
	}
	...
	{
		return DayFieldDefaultToNowItem.dateNow.get(this);
	}
	...
	void setDateNow(@javax.annotation.Nonnull final java.util.Date dateNow)
			throws
				com.exedio.cope.MandatoryViolationException
	{
		DayFieldDefaultToNowItem.dateNow.set(this,dateNow);
	}
	...
	void touchDateNow()
	{
		DayFieldDefaultToNowItem.dateNow.touch(this);
	}
	...
	{
		return DayFieldDefaultToNowItem.dateNowOpt.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.dateNowOpt.set(this,dateNowOpt);
	}
	...
	{
		DayFieldDefaultToNowItem.dateNowOpt.touch(this);
	}
	...
	{
		return DayFieldDefaultToNowItem.dateNone.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.dateNone.set(this,dateNone);
	}
	...
	void touchDateNone()
	{
		DayFieldDefaultToNowItem.dateNone.touch(this);
	}
	...
	{
		return DayFieldDefaultToNowItem.dayEight.get(this);
	}
	...
	void setDayEight(@javax.annotation.Nonnull final com.exedio.cope.util.Day dayEight)
			throws
				com.exedio.cope.MandatoryViolationException
	{
		DayFieldDefaultToNowItem.dayEight.set(this,dayEight);
	}
	...
	{
		DayFieldDefaultToNowItem.dayEight.touch(this,zone);
	}
	...
	{
		return DayFieldDefaultToNowItem.longRandom.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.longRandom.set(this,longRandom);
	}
	...
	{
		return DayFieldDefaultToNowItem.enumOne.get(this);
	}
	...
	void setEnumOne(@javax.annotation.Nonnull final DefaultToEnum enumOne)
			throws
				com.exedio.cope.MandatoryViolationException
	{
		DayFieldDefaultToNowItem.enumOne.set(this,enumOne);
	}
	...
	{
		return DayFieldDefaultToNowItem.enumTwo.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.enumTwo.set(this,enumTwo);
	}
	...
	{
		return DayFieldDefaultToNowItem.enumNone.get(this);
	}
	...
	{
		DayFieldDefaultToNowItem.enumNone.set(this,enumNone);
	}
