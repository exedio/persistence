...
public class ChangeHookDefaultOnlyTest extends ChangeHookAbstractTest
{
	@Test void testIt()
	{
		assertEquals(
		...
		assertEvents(
				...
				"Item#afterNew(" + i + ")");
		assertEquals("onCreate / Item#beforeNew", i.getField());

		i.setField("onSet");
		assertEvents(
				"Item#beforeSet(" + i + ",onSet)");
		assertEquals("onSet / Item#beforeSet", i.getField());
	...
	public ChangeHookDefaultOnlyTest()
	{
		super(MODEL);
	}
}
