...
public class CopyConstraintSupplierSelfToTest
{
	@Test void testIt()
	{
		assertFails(
				...
				"copy and template are identical for CopyConstraint Source.target.copyTo(field,Source.field) (Source.fieldCopyFromtarget), " +
				"use copyToSelf instead");
	}
	...
	private static final class Source extends Item
	{
		...
		static final ItemField<Source> target = ItemField.create(Source.class).toFinal().copyTo(field, () -> field);
