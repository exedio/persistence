...
public class Main
{
	...
	public static final Model typeNotInConditionModel = new Model(new Type[] { TypeNotInConditionAItem.TYPE, TypeNotInConditionB1Item.TYPE, TypeNotInConditionB2Item.TYPE, TypeNotInConditionC1Item.TYPE, TypeNotInConditionRefItem.TYPE });
