...
public class Main
{
	...
	public static final Model typeInConditionModel = new Model(new Type[] { TypeNotInConditionAItem.TYPE, TypeInConditionB1Item.TYPE, TypeInConditionB2Item.TYPE, TypeNotInConditionC1Item.TYPE, TypeNotInConditionRefItem.TYPE });
