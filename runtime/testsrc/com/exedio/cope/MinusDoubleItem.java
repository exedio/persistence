...
public class MinusDoubleItem extends Item
{
	...
	public static final MinusView<Double> divideAB = numA.minus(numB);

	public static final MinusView<Double> divideAC = numA.minus(numC);

	public static final MinusView<Double> divideBC = numB.minus(numC);
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private MinusDoubleItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	...
	{
		return MinusDoubleItem.divideAB.get(this);
	}/**
	...
	{
		return MinusDoubleItem.divideAC.get(this);
	}/**
	...
	{
		return MinusDoubleItem.divideBC.get(this);
	}/**
