...
public class DateConsistencyTest
{
	...
	{
		final Instant instant = LocalDateTime.of(1900, 1, 23, 3, 34, 45, 876000000).toInstant(UTC);
		...
		assertEquals(
				...
				format.parse("1900-01-23 03:34:45.876").getTime());
	}
	...
	{
		final Instant instant = LocalDateTime.of(1600, 1, 23, 3, 34, 45, 876000000).toInstant(UTC);
		...
		assertEquals(
				instant.toEpochMilli(),
				format.parse("1600-01-23 03:34:45.876").getTime());
	}
	...
	{
		final Instant instant = LocalDateTime.of(1588, 1, 23, 3, 34, 45, 876000000).toInstant(UTC);
		...
		assertEquals(
				instant.toEpochMilli(),
				format.parse("1588-01-23 03:34:45.876").getTime());
	}
	...
	{
		final Instant instant = LocalDateTime.of(1500, 1, 23, 3, 34, 45, 876000000).toInstant(UTC);
		...
		assertEquals(
				instant.toEpochMilli(),
				format.parse("1500-01-14 03:34:45.876").getTime()); // TODO don't know why day of month is not 23
	}
