...
class CopySourceItem extends Item
{
	...
	String getTemplateString() // TODO generate by instrumentor
	{
		return templateString.getCopy().get(this);
	}
	
	CopyValueItem getTemplateItem() // TODO generate by instrumentor
	{
		return templateItem.getCopy().get(this);
	}
