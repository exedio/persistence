...
{
	public static final ItemField<TypeInConditionAItem> ref = newItemField(FINAL, TypeInConditionAItem.class);
	public static final StringField code = new StringField(FINAL_UNIQUE);
	public static final ItemField<TypeInConditionB2Item> refb2 = newItemField(OPTIONAL, TypeInConditionB2Item.class);
