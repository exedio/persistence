	...
	implements MediaUrlCatchphraseProvider
{
	...
	{
		return MediaServletItem.thumbnailMagick.getLocatorWithFallbackToSource(this);
	}/**
	...
	{
		return MediaServletItem.thumbnailMagickPng.getLocatorWithFallbackToSource(this);
	}/**
	...
	{
		return MediaServletItem.thumbnailMagickPngBlue.getLocatorWithFallbackToSource(this);
	}/**
	 ...
	 **
	 * Returns a URL the content of {@link #thumbnailMagickSame} is available under, falling back to source if necessary.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getURLWithFallbackToSource public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	 ...
	 **
	 * Returns a Locator the content of {@link #thumbnailMagickSame} is available under, falling back to source if necessary.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getLocatorWithFallbackToSource public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final com.exedio.cope.pattern.MediaPath.Locator getThumbnailMagickSameLocatorWithFallbackToSource()
	{
		return MediaServletItem.thumbnailMagickSame.getLocatorWithFallbackToSource(this);
	}/**
