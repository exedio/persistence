...
final class MediaServletItem extends Item
{
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private MediaServletItem(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
	 ...
	 **
	 * Returns the content type of the media {@link #html}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getContentType public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.String getHtmlContentType()
	{
		return MediaServletItem.html.getContentType(this);
	}/**
	 ...
	 */
	final void addHtmlPaste(final java.lang.String key,final com.exedio.cope.pattern.Media.Value value)
	{
		MediaServletItem.html.addPaste(this,key,value);
	}/**
	...
	{
		return MediaServletItem.tokened.getContentType(this);
	}/**
