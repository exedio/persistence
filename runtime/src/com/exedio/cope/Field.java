...
public abstract class Field<E> extends Feature implements Settable<E>
{
	...
	final void connect(final Table table, final ModelMetrics metrics)
	{
		if(table==null)
	...
	abstract Column createColumn(Table table, String name, boolean optional, final ModelMetrics metrics);
