...
public final class CompareFunctionCondition<E> extends Condition
{
	 ...
	 * @see com.exedio.cope.Function#is(Function)
	 * @see com.exedio.cope.Function#isNot(Function)
	...
	public void forEachFieldCovered(final Consumer<Field<?>> action)
	{
		...
		right.forEachFieldCovered(action);
	}
	...
	{
		return new CompareFunctionCondition<>(operator, left.bind(join), right.bind(join));
	}
	...
	{
		if(!(other instanceof final CompareFunctionCondition<?> o))
			return false;
