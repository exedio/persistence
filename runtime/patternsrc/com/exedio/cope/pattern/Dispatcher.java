...
public final class Dispatcher extends Pattern
{
	...
	@Wrapped(order=1000, comment="Returns the parent field of the run type of {0}.", name="{1}RunParent")
	 ...
	 */
	@Wrapped(order=10, comment = "Dispatch by {0}.",
	...
	@Wrapped(order=20, comment = "Dispatch by {0}.")
	...
	@Wrapped(order=30, comment = "Returns, whether this item is yet to be dispatched by {0}.")
	public boolean isPending(final Item item)
	{
		return pending.getMandatory(item);
	}

	@Wrapped(order=40, comment = "Sets whether this item is yet to be dispatched by {0}.")
	...
	@Wrapped(order=50, comment = "Returns the date, this item was last successfully dispatched by {0}.")
	...
	@Wrapped(order=60, comment = "Returns the milliseconds, this item needed to be last successfully dispatched by {0}.")
	...
	@Wrapped(order=70, comment = "Returns the attempts to dispatch this item by {0}.")
	...
	@Wrapped(order=80, comment = "Returns the failed attempts to dispatch this item by {0}.")
