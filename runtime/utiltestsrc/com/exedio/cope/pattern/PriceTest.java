...
public final class PriceTest extends CopeAssert
{
	...
	public static void testValueOfDouble()
	{
		...
		assertEquals( 304, valueOf( 3.044  ).store()); // because the next digit is 5, and the hundredths digit (4) is even)
		...
		assertEquals( 305, valueOf( 3.046  ).store()); // because the next digit is 5, but it is followed by non-zero digits)
