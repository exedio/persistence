...
public class MediaTypeMediaTest extends CopeAssert
{
	...
	public void testDefault()
	{
		...
		assertEquals(
				...
				"(("+c+"='application/zip' OR "+c+"='application/java-archive' OR "+c+"='application/vnd.openxmlformats-officedocument.wordprocessingml.document') AND !("+b+" startsWith '"+ZIP+"')) OR " +
				"(("+c+"='application/font-woff' OR "+c+"='font/x-woff') AND !("+b+" startsWith '774f4646')) OR " +
