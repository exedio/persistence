...
final class ThumbnailUrlFallbackItem extends Item
{
	...
	{
		return ThumbnailUrlFallbackItem.anFilter.getLocatorWithFallbackToSource(this);
	}/**
	...
	{
		return ThumbnailUrlFallbackItem.nonSupportedFilter.getLocatorWithFallbackToSource(this);
	}/**
