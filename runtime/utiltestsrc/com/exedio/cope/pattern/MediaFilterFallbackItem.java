...
final class MediaFilterFallbackItem extends Item
{
	...
	final byte[] getAnFilter()
			throws
				java.io.IOException
	{
		return MediaFilterFallbackItem.anFilter.get(this);
	}/**
	...
	final byte[] getNonSupportedFilter()
			throws
				java.io.IOException
	{
		return MediaFilterFallbackItem.nonSupportedFilter.get(this);
	}/**
	...
	final byte[] getSupportedFilter()
			throws
				java.io.IOException
	{
		return MediaFilterFallbackItem.supportedFilter.get(this);
	}/**
