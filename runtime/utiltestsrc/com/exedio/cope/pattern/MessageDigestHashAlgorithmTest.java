...
public class MessageDigestHashAlgorithmTest extends CopeAssert
{
	...
	@Test public void testSaltedMinimal()
	{
		final HashAlgorithm a =
	...
	@Test public void testNoniterated()
	{
		final HashAlgorithm a =
	...
	@Test public void testUnsaltedNoniterated()
	{
		final HashAlgorithm a =
	...
	@Test public void testUnsaltedNoniteratedMD5()
	{
		final HashAlgorithm a =
	...
	private static void assertDigestNull(final HashAlgorithm algorithm)
	{
		try
		{
			algorithm.hash(null);
	...
	private int mockSecureRandomInternalLength = -1;

	private MockSecureRandom random(final int length)
	{
		assertNull(mockSecureRandomInternal);
		mockSecureRandomInternal = new MockSecureRandom();
		mockSecureRandomInternalLength = length;
