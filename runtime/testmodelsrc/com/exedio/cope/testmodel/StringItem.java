...
public class StringItem extends Item
{
	...
	// TODO remove
	public static final StringAttribute max5Unchecked = new StringAttribute(OPTIONAL).lengthMax(5);
	...
	public StringItem(final String max5Unchecked, Date dummy) throws LengthViolationException
	{
		this(new AttributeValue[]{
