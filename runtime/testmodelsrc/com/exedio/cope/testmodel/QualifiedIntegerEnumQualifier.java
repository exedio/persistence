...
{
	public static final ItemField<QualifiedItem> up = newItemField(QualifiedItem.class, CASCADE).toFinal();
	
	public static final IntegerField keyX = new IntegerField().toFinal();
	...
	public QualifiedIntegerEnumQualifier(
				final com.exedio.cope.testmodel.QualifiedItem up,
				final int keyX,
				final KeyEnum keyY)
			throws
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	@SuppressWarnings("unused") private QualifiedIntegerEnumQualifier(final com.exedio.cope.util.ReactivationConstructorDummy d,final int pk)
	{
		super(d,pk);
	}/**
	 ...
	 */
	public final com.exedio.cope.testmodel.QualifiedItem getUp()
	{
		return QualifiedIntegerEnumQualifier.up.get(this);
	}/**

	 **
	 * Returns the value of {@link #keyX}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	 ...
	 **
	 * Returns the value of {@link #keyY}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.get public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	public static final QualifiedIntegerEnumQualifier forQualifyUnique(final QualifiedItem up,final int keyX,final KeyEnum keyY)
	{
		return QualifiedIntegerEnumQualifier.qualifyUnique.searchUnique(QualifiedIntegerEnumQualifier.class,up,keyX,keyY);
	}/**
