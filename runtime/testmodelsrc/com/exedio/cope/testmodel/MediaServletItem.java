...
public class MediaServletItem extends Item
{
	...
	public MediaServletItem(final String name)
	{
	...
	{
		return MediaServletItem.file.isNull(this);
	}/**
	...
	{
		return MediaServletItem.file.getURL(this);
	}/**
	...
	{
		return MediaServletItem.file.getContentType(this);
	}/**
	...
	{
		return MediaServletItem.file.getLastModified(this);
	}/**
	...
	{
		return MediaServletItem.file.getLength(this);
	}/**
	...
	{
		return MediaServletItem.file.getBody(this);
	}/**
	...
	public final void getFileBody(final java.io.OutputStream body)
			throws
				java.io.IOException
	{
		MediaServletItem.file.getBody(this,body);
	}/**
	...
	public final void setFile(final byte[] body,final java.lang.String contentType)
			throws
				java.io.IOException
	{
		MediaServletItem.file.set(this,body,contentType);
	}/**
	...
	{
		return MediaServletItem.image.isNull(this);
	}/**
	...
	{
		return MediaServletItem.image.getURL(this);
	}/**
	...
	{
		return MediaServletItem.image.getContentType(this);
	}/**
	...
	{
		return MediaServletItem.image.getLastModified(this);
	}/**
	...
	{
		return MediaServletItem.image.getLength(this);
	}/**
	...
	{
		return MediaServletItem.image.getBody(this);
	}/**
	...
	public final void getImageBody(final java.io.OutputStream body)
			throws
				java.io.IOException
	{
		MediaServletItem.image.getBody(this,body);
	}/**
	...
	public final void setImage(final byte[] body,final java.lang.String contentType)
			throws
				java.io.IOException
	{
		MediaServletItem.image.set(this,body,contentType);
	}/**
	...
	{
		return MediaServletItem.photo.isNull(this);
	}/**
	...
	{
		return MediaServletItem.photo.getURL(this);
	}/**
	...
	{
		return MediaServletItem.photo.getContentType(this);
	}/**
	...
	{
		return MediaServletItem.photo.getLastModified(this);
	}/**
	...
	{
		return MediaServletItem.photo.getLength(this);
	}/**
	...
	{
		return MediaServletItem.photo.getBody(this);
	}/**
	...
	public final void getPhotoBody(final java.io.OutputStream body)
			throws
				java.io.IOException
	{
		MediaServletItem.photo.getBody(this,body);
	}/**
	...
	public final void setPhoto(final byte[] body,final java.lang.String contentType)
			throws
				java.io.IOException
	{
		MediaServletItem.photo.set(this,body,contentType);
	}/**
