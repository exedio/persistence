...
public class UniqueFinal extends Item
{
	 ...
	 */
	public static final StringAttribute uniqueReadOnlyString = new StringAttribute(FINAL_UNIQUE_OPTIONAL);

/**

	 **
	 * Creates a new UniqueFinal with all the attributes initially needed.
				...
				com.exedio.cope.UniqueViolationException
	{
		this(new com.exedio.cope.AttributeValue[]{
			UniqueFinal.uniqueReadOnlyString.map(uniqueReadOnlyString),
		});
		throwInitialUniqueViolationException();
	}/**

	 **
	 * Creates a new UniqueFinal and sets the given attributes initially.
	 ...
	 */
	private UniqueFinal(final com.exedio.cope.AttributeValue[] initialAttributes)
	{
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	private UniqueFinal(com.exedio.cope.util.ReactivationConstructorDummy d,final int pk)
	{
		super(d,pk);
	}/**
	...
	{
		return UniqueFinal.uniqueReadOnlyString.get(this);
	}/**

	 **
	 * Finds a uniqueFinal by it's unique attributes.
	 * @param uniqueReadOnlyString shall be equal to attribute {@link #uniqueReadOnlyString}.
	 * @return null if there is no matching item.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	public static final UniqueFinal findByUniqueReadOnlyString(final java.lang.String uniqueReadOnlyString)
	{
		return (UniqueFinal)UniqueFinal.uniqueReadOnlyString.searchUnique(uniqueReadOnlyString);
	}/**
	...
	public static final com.exedio.cope.Type TYPE =
		new com.exedio.cope.Type(UniqueFinal.class)
;}
