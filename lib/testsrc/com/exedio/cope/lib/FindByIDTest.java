...
public class FindByIDTest extends DatabaseLibTest
{
	...
	public void testFindbyID()
	{
		...
		assertFail("ItemWithManyAttributes.-1", "no such id number <-1>, must be positive");
		assertFail("ItemWithManyAttributes.50", "no such id <ItemWithManyAttributes.50>, item <50> does not exist");
	}
