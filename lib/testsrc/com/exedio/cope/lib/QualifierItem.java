 ...
 * @persistent
 */
public class QualifierItem extends Item
{
	static final ItemAttribute parent = new ItemAttribute(READ_ONLY_NOT_NULL, QualifiedItem.class);
	
	static final ItemAttribute key = new ItemAttribute(READ_ONLY_NOT_NULL, ItemWithoutAttributes.class);
...
/**
	 ...
	 **
	 * Constructs a new QualifierItem with all the attributes initially needed.
 ...
 */QualifierItem(
				...
				final ItemWithoutAttributes initialKey)
			throws
	 ...
	 *
 */private QualifierItem(com.exedio.cope.lib.util.ReactivationConstructorDummy d,final int pk)
	{
		super(d,pk);
	}/**
 ...
 */final QualifiedItem getParent()
	 ...
	 * <p><small>Generated by the cope instrumentor.</small>
	 *
 */final ItemWithoutAttributes getKey()
	{
		return (ItemWithoutAttributes)getAttribute(this.key);
	}/**
 ...
 */final void setQualifiedB(final String qualifiedB)
	 ...
	 **
	 * Finds a qualifierItem by it's unique attributes.
	 * <p><small>Generated by the cope instrumentor.</small>
	 * @param searchedParent shall be equal to attribute {@link #parent}.
	 * @param searchedKey shall be equal to attribute {@link #key}.
	 *
 */static final QualifierItem findByQualifyUnique(final QualifiedItem searchedParent,final ItemWithoutAttributes searchedKey)
	{
		return (QualifierItem)searchUnique(TYPE,and(equal(parent,searchedParent),equal(key,searchedKey)));
	}/**

	 **
	 * The persistent type information for qualifierItem.
	 * <p><small>Generated by the cope instrumentor.</small>
	 *
 */public static final com.exedio.cope.lib.Type TYPE = 
		new com.exedio.cope.lib.Type(QualifierItem.class)
;}
