...
/**
	 ...
	 * @throws com.exedio.cope.NotNullViolationException if initialSomeNotNullString, initialSomeNotNullItem, initialSomeNotNullEnumeration is null.
	 *
 */public AttributeItem(
				...
				com.exedio.cope.NotNullViolationException
	{
		this(new com.exedio.cope.AttributeValue[]{
			new com.exedio.cope.AttributeValue(someNotNullString,initialSomeNotNullString),
			new com.exedio.cope.AttributeValue(someNotNullInteger,new java.lang.Integer(initialSomeNotNullInteger)),
			new com.exedio.cope.AttributeValue(someNotNullLong,new java.lang.Long(initialSomeNotNullLong)),
			new com.exedio.cope.AttributeValue(someNotNullDouble,new java.lang.Double(initialSomeNotNullDouble)),
			new com.exedio.cope.AttributeValue(someNotNullBoolean,(initialSomeNotNullBoolean?java.lang.Boolean.TRUE:java.lang.Boolean.FALSE)),
			new com.exedio.cope.AttributeValue(someNotNullItem,initialSomeNotNullItem),
			new com.exedio.cope.AttributeValue(someNotNullEnumeration,initialSomeNotNullEnumeration),
		});
