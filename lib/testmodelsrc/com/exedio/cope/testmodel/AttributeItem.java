...
public class AttributeItem extends Item
{
	 ...
	 * @cope.setter none
	 */
	public static final DataAttribute someDataData = dataAttribute(DEFAULT);
	/**
	 * A data attribute.
	 */
	public static final HttpEntity someData = new HttpEntity(DEFAULT, someDataData, stringAttribute(DEFAULT, 1, 30), stringAttribute(DEFAULT));
 ...
 */public final void setSomeNotNullEnum(final SomeEnum someNotNullEnum)
	 ...
	 **
	 * Returns the value of the persistent attribute {@link #someDataData}.
	 * @cope.generated This method has been generated by the cope instrumentor and will be overwritten by the build process.
	 *
 */public final java.io.InputStream getSomeDataData()
	{
		return (java.io.InputStream)get(AttributeItem.someDataData);
	}/**
