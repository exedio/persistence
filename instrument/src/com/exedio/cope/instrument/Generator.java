...
final class Generator
{
	...
	private final boolean serialAnnotation;

	/**
	 * Adds a comment before the first piece of code generated by the instrumentor.
	 * <p>
	 * BEWARE:
	 * This code is added every time the instrumentor runs. Comments generated by
	 * later runs do NOT replace those generated by earlier runs. Instead, comments of
	 * subsequent runs do accumulate.
	 * <p>
	 * This parameter is meant to be used for one-time mass insertions only.
	 * Do not commit this parameter to any source control system.
	 */
	private final String introCommentOneTime;
	...
	Generator(final JavaFile javaFile, final StringBuilder output, final Params params, final Set<Method> generateDeprecateds, final Set<Method> disabledWraps)
	{
		...
		this.serialAnnotation = params.serialAnnotation;
	...
	private void writeSerialVersionUID(final LocalCopeType type)
	{
		...
		if(serialAnnotation)
			writeEmptyAnnotationOnSeparateLine(Serial.class);
		writeIndent();
	...
	private void writeClassFeatures(final LocalCopeType type)
	{
		...
		if(introCommentOneTime!=null)
		{
			writeIndent();
			write("//");
			write(introCommentOneTime);
			write(lineSeparator);
		}
