...
final class Generator
{
	...
	{
		writeCommentFooter(null, null);
	}

	private void writeCommentFooter(final String extraCommentForTags, final String extraCommentForAnnotations)
	{
		if (hintFormat==HintFormat.forTags)
		{
			writeIndent();
			write(" * @" + CopeFeature.TAG_PREFIX + "generated" +
	...
	private void writeInitialConstructor(final CopeType type)
	{
		...
		writeCommentFooter(CONSTRUCTOR_INITIAL_CUSTOMIZE_TAGS, CONSTRUCTOR_INITIAL_CUSTOMIZE_ANNOTATIONS);
	...
	private void writeGenericConstructor(final CopeType type)
	{
		...
		write(lineSeparator);
		writeCommentFooter(CONSTRUCTOR_GENERIC_CUSTOMIZE_TAGS, CONSTRUCTOR_GENERIC_CUSTOMIZE_ANNOTATIONS);
