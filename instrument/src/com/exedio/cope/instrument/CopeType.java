...
final class CopeType
{
		...
		throws ParserException
	{
		...
		this.typeOption                  = new Option(Parser.findDocTagLine(docComment, TAG_TYPE),                   false);
		this.initialConstructorOption    = new Option(Parser.findDocTagLine(docComment, TAG_INITIAL_CONSTRUCTOR),    false);
		this.genericConstructorOption    = new Option(Parser.findDocTagLine(docComment, TAG_GENERIC_CONSTRUCTOR),    false);
		this.activationConstructorOption = new Option(Parser.findDocTagLine(docComment, TAG_ACTIVATION_CONSTRUCTOR), false);
