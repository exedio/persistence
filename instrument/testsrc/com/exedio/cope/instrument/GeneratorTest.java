...
public class GeneratorTest
{
	...
	@Test void testStandard()
	{
		...
		assertMethod(STANDARD, "getPublicHashpubID", String.class, PUBLIC);
		assertMethod(STANDARD, "getPrivateHashprivID", String.class, PRIVATE);
		assertMethod(STANDARD, "getMandatoryHashmanID", String.class, PUBLIC);
		assertMethod(STANDARD, "getPrivateSetterHashprivSetID", String.class, PUBLIC);
		assertMethod(STANDARD, "setPublicHashpubID", new Class<?>[]{STRING}, PUBLIC);
		assertMethod(STANDARD, "setPrivateHashprivID", new Class<?>[]{STRING}, PRIVATE);
		assertMethod(STANDARD, "setMandatoryHashmanID", new Class<?>[]{STRING}, PUBLIC, new Class<?>[]{MANDATORY_VIOLATION});
		assertMethod(STANDARD, "setPrivateSetterHashprivSetID", new Class<?>[]{STRING}, PUBLIC, new Class<?>[]{MANDATORY_VIOLATION});
