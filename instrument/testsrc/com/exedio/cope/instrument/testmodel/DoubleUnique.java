...
public class DoubleUnique extends Item
{
	...
	public static final ItemAttribute item = new ItemAttribute(READ_ONLY, SubTarget.class, CASCADE);
 ...
 */public DoubleUnique(
				...
				com.exedio.cope.UniqueViolationException
	{
		this(new com.exedio.cope.AttributeValue[]{
			new com.exedio.cope.AttributeValue(DoubleUnique.string,string),
			new com.exedio.cope.AttributeValue(DoubleUnique.item,item),
		});
