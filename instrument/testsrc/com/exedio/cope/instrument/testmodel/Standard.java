...
/**
	 ...
	 * @param initialNotNullString the initial value for attribute {@link #notNullString}.
	 ...
	 * @throws com.exedio.cope.NotNullViolationException if initialNotNullString is null.
	 *
 */public Standard(
				final java.lang.String initialNotNullString,
				...
				com.exedio.cope.NotNullViolationException
	{
		this(new com.exedio.cope.AttributeValue[]{
			new com.exedio.cope.AttributeValue(notNullString,initialNotNullString),
			new com.exedio.cope.AttributeValue(readOnlyString,initialReadOnlyString),
			new com.exedio.cope.AttributeValue(nativeInteger,new java.lang.Integer(initialNativeInteger)),
			new com.exedio.cope.AttributeValue(nativeLong,new java.lang.Long(initialNativeLong)),
			new com.exedio.cope.AttributeValue(nativeDouble,new java.lang.Double(initialNativeDouble)),
			new com.exedio.cope.AttributeValue(nativeBoolean,(initialNativeBoolean?java.lang.Boolean.TRUE:java.lang.Boolean.FALSE)),
		});
