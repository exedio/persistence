...
class CrossPackageSuper extends Item
{
	...
	// TODO static final EnumField<EnumContainer.Enum3> externalEnum = newEnumField(EnumContainer.Enum3.class).toFinal();
	 ...
	 * @throws com.exedio.cope.MandatoryViolationException if superField, superField2, shortExternalEnum is null.
	 ...
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 */
	protected CrossPackageSuper(final com.exedio.cope.ActivationParameters ap)
	{
		super(ap);
	}/**
