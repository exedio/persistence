...
{
	static final ItemField<GenericSimpleSub> toSub = ItemField.create(GenericSimpleSub.class);
	static final ItemField<GenericSimpleSuper> toSuper = ItemField.create(GenericSimpleSuper.class);
