...
final class ClassPackage extends Item
{
	public static final SettableFixed field = new SettableFixed();


	/**
	 * Creates a new ClassPackage with all the fields initially needed.
				...
				@javax.annotation.Nonnull final java.util.concurrent.atomic.AtomicBoolean field)
	{
		this(new com.exedio.cope.SetValue<?>[]{
			com.exedio.cope.SetValue.map(ClassPackage.field,field),
		});
	}

	/**
	 * Creates a new ClassPackage and sets the given fields initially.
	 */
	@com.exedio.cope.instrument.Generated // customize with @WrapperType(genericConstructor=...)
	private ClassPackage(final com.exedio.cope.SetValue<?>... setValues){super(setValues);}
