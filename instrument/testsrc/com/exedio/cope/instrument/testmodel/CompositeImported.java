...
public final class CompositeImported extends Composite
{
	static final StringField field = new StringField();

	/**
	 * Creates a new CompositeImported with all the fields initially needed.
	...
	{
		return get(CompositeImported.field);
	}
