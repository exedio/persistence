...
{
	public static final StringAttribute superMandatory = new StringAttribute(MANDATORY);
	
	/**
	 * @cope.initial
	 */
	public static final StringAttribute superInitial = new StringAttribute(OPTIONAL);
 ...
 */public final void setSuperMandatory(final java.lang.String superMandatory)
	 ...
	 *       It can be customized with the tag <code>@cope.getter public|package|protected|private|none|non-final|boolean-as-is</code> in the comment of the attribute.
	 *
 */public final java.lang.String getSuperInitial()
	{
		return (java.lang.String)get(Super.superInitial);
	}/**
	 ...
	 *       It can be customized with the tag <code>@cope.setter public|package|protected|private|none|non-final</code> in the comment of the attribute.
	 *
 */public final void setSuperInitial(final java.lang.String superInitial)
	{
		try
		{
